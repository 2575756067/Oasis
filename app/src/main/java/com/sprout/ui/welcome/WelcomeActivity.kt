...
import com.sprout.ui.LoginActivity
...
import kotlinx.android.synthetic.main.layout_welcome_pop.view.*
...
class WelcomeActivity : AppCompatActivity() {
    ...
    private fun initPw() {
        ...
        val popupView: View = LayoutInflater.from(this@WelcomeActivity)
            .inflate(R.layout.layout_welcome_pop, null)
        //设置popu
